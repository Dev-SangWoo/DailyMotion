...
- [ ] 혼잡도 데이터 소스 (1단계: 역/구간 단위 평균 혼잡도)
  - [ ] 서울교통공사_지하철혼잡도정보 활용
    - [ ] 노선/역/시간대별 평균 혼잡도(예: 혼잡률 %)를 수집·파싱
...
- [ ] Logic 1.1/1.2/2.2/3.1 반영
  - [ ] 현재 경로/구간의 혼잡도를 조회하여:
    - [ ] 메시지에 혼잡도 텍스트 추가 (예: “현재 구간 혼잡도: 매우 높음(90%)”)
    - [ ] Logic 2.2 Gate 3(경험의 질)에서 혼잡도가 너무 높은 경로는 페널티 부여
